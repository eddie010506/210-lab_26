...
#include <iomanip>
using namespace std;
// had a different solution for the lab so copied from the solutions
        ...
        for (int i = 0; i < STRUCTURES; i++) {
            ...
            switch(i) {
                case 0: {  // read into a vector
                    ...
                    results[CURRENT][0][i] = duration.count();
                    break;
                }
        ...
        for (int i = 0; i < STRUCTURES; i++) {
            ...
            switch(i) {
                case 0: {  // sort a vector
                    ...
                    auto end = chrono::high_resolution_clock::now();
                    auto duration = chrono::duration_cast<chrono::microseconds>(end - start);
                    results[CURRENT][1][i] = duration.count();
                    break;
                }
                case 1: {  // sort a list
                    data_list.sort();
        ...
        for (int i = 0; i < STRUCTURES; i++) {
            ...
            switch(i) {
                case 0: {  // insert into a vector
                    ...
                    auto end = chrono::high_resolution_clock::now();
                    auto duration = chrono::duration_cast<chrono::microseconds>(end - start);
                    results[CURRENT][2][i] = duration.count();
                    break;
                }
        ...
        // select a target value in the set
            ...
            switch(i) {
                case 0: {  // delete by value from vector
                    ...
                    auto end = chrono::high_resolution_clock::now();
                    auto duration = chrono::duration_cast<chrono::microseconds>(end - start);
                    results[CURRENT][3][i] = duration.count();
                    break;
                }
